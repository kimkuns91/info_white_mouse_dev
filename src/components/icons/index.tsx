...
export function LogoIcon({ className, ...props }: IconProps) {
  return (
    ...
    >
      {/* 마우스 몸통 */}
      <path
        d="M12 2C8.13401 2 5 5.13401 5 9V15C5 18.866 8.13401 22 12 22C15.866 22 19 18.866 19 15V9C19 5.13401 15.866 2 12 2Z"
        fill="currentColor"
        fillOpacity="0.2"
      />
      {/* 돋보기 원 */}
      <circle cx="12" cy="9" r="4" stroke="currentColor" strokeWidth="2.5" />
      {/* 돋보기 손잡이 */}
      <path
        d="M15 12L18 15"
        stroke="currentColor"
